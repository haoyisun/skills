...
`read-project`, `read-standard`, and `read-fast` depend on `technical-diagrams` for their diagrams. Install it together with them, or install the whole repository to get them all at once.
